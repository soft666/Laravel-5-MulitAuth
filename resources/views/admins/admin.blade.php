						...
						<div class="panel-body">
							...
							{!! Form::open(['class' => 'form-horizontal', 'route' => 'LoginAdminPost']) !!}
		                        ...
		                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
		                            ...
		                            <div class="col-md-6">
		                                <input type="text" class="form-control" name="name" value="{{ Auth::guard('web_admins')->user()->name }}">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
		                            ...
		                            <div class="col-md-6">
		                                <input type="email" class="form-control" name="email" value="{{ Auth::guard('web_admins')->user()->email }}">
		                            </div>
		                        </div>
